...
SRC_TRAIN_NEWS_PATH = '../../data/mind/MINDlarge_train/news.tsv'
DST_TRAIN_NEWS_PATH = f'../../data/mind/MINDlarge_train/news_full_{ABBR}.pkl'
SRC_TRAIN_USER_PATH = '../../data/mind/MINDlarge_train/behaviors.tsv'
DST_TRAIN_USER_PATH = '../../data/mind/MINDlarge_train/behaviors.csv'

SRC_TEST_NEWS_PATH = '../../data/mind/MINDlarge_dev/news.tsv'
DST_TEST_NEWS_PATH = f'../../data/mind/MINDlarge_dev/news_full_{ABBR}.pkl'
SRC_TEST_USER_PATH = '../../data/mind/MINDlarge_dev/behaviors.tsv'
DST_TEST_USER_PATH = '../../data/mind/MINDlarge_dev/behaviors.csv'

CONFIG_PATH = F'../../data/mind/{ABBR}_config.json'
...
if TRANSFORM_BEHAVIORS:
    ...
    train_user_df, user_idx = MindHandler.index_category(train_user_df, 'user', return_category_idx=True)
    train_user_df.to_csv(DST_TRAIN_USER_PATH)

    test_user_df = MindHandler.read_behaviours_tsv(src_path=SRC_TEST_USER_PATH)
    test_user_df = MindHandler.index_category(test_user_df, column='user', category_idx=user_idx)
    test_user_df.to_csv(DST_TEST_USER_PATH)

#TODO: add click computation